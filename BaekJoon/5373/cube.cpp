...
void turn_side_cw(side s) {
	char tmp2d[3][3] = {
		{ cube[s][2][0], cube[s][1][0], cube[s][0][0] },
		{ cube[s][2][1], cube[s][1][1], cube[s][0][1] },
		{ cube[s][2][2], cube[s][1][2], cube[s][0][2] }
	};
	for (int i = 0; i < 3; i++) for (int j = 0; j < 3; j++) cube[s][i][j] = tmp2d[i][j]; 
}

void turn_side_ccw(side s) {
	char tmp2d[3][3] = {
		{ cube[s][0][2], cube[s][1][2], cube[s][2][2] },
		{ cube[s][0][1], cube[s][1][1], cube[s][2][1] },
		{ cube[s][0][0], cube[s][1][0], cube[s][2][0] }
	};
	for (int i = 0; i < 3; i++) for (int j = 0; j < 3; j++) cube[s][i][j] = tmp2d[i][j];\
}
